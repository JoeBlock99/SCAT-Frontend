              ...
              <div>
                <template v-if="room && room.started">
                  ...
                  <div v-if="!selectingDeck" class="uk-margin-top">
                    ...
                    <button :disabled="!isAlive || !isCurrentTurn" v-if="isAskingForCard != 1" @click.once="() => sendHandProcess()" class="uk-button uk-button-primary uk-margin-right">Mandar mano</button>
